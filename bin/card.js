...
const styledDataFilename = 'mbonyinshuti-info.json';
...
try {
  ...
  const styledData = {
    ...
    blog: chalk.cyan(blog_link),

    labelCard: chalk.white.bold('Card:'),
    npxCard: chalk.white.underline('npx mbonyinshuti'),
  };
  ...
  const output =
    ...
    newline +
    `${styledData.labelBlog}  ${styledData.blog}` +
    newline +
